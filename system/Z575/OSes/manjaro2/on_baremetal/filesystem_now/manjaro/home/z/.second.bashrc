...
alias grep='grep --color=tty -d skip --exclude-dir=.git --exclude-dir=.hg --exclude-dir=.svn'
alias grepcolor='grep --color=always -d skip --exclude-dir=.git --exclude-dir=.hg --exclude-dir=.svn'
